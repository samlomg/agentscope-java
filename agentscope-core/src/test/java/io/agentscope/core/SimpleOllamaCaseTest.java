...
public class SimpleOllamaCaseTest {
    ...
    public void test(){
        ...
        OllamaOptions options = OllamaOptions.builder()
                ...
                .thinkOption(ThinkOption.ThinkBoolean.ENABLED)  // 开启思考模式
                .build();

        // 注意：thinking 功能需要使用支持 thinking 的模型，如：
        // - qwen3 (推荐)
        // - deepseek-r1
        // - gemma3
        // qwen3.5 不支持 thinking，会直接跳过思考过程
                    ...
                    if (block instanceof ThinkingBlock tb) {
                        ...
                        if (thinking != null && !thinking.isBlank()) {
                            ...
                            if (!thinkingHeaderPrinted) {
                                System.out.println(CYAN + "╭─ 思考过程 ─────────────────────────╮" + RESET);
        ...
        ReActAgent agent = ReActAgent.builder()
                ...
                .toolkit(toolkit)
                .hook(streamingHook)  // 添加流式输出 Hook
                .build();
